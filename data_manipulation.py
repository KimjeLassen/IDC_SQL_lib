...
def perform_kmeans_and_hierarchical(data, n_clusters):
    ...
    try:
        ...
        logger.error("An error occurred during K-Means and Agglomerative clustering:", exc_info=True)
...
def perform_dbscan(data, dbscan_eps, dbscan_min_samples):
    ...
    try:
        ...
        if n_clusters > 1:
            ...
            dbscan_silhouette = silhouette_score(data[core_samples_mask], dbscan_labels[core_samples_mask])
